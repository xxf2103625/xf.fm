...
namespace Xf.FM.DataTables
{
    ...
    /// </summary>
    public class DTResponse : IDataTablesResponse
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            {                 
                if (IsSuccessResponse())
                {
                    ...
                    if (Xf.FM.DataTables.Configuration.Options.IsResponseAdditionalParametersEnabled && AdditionalParameters != null)
                    {
        ...
        protected DTResponse(int draw, string errorMessage)
        ...
        /// <param name="draw">Draw count from request object.</param>
        /// <param name="errorMessage">Error message.</param>
        protected DTResponse(int draw, string errorMessage, IDictionary<string, object> additionalParameters)
        {
            Draw = draw;
            Error = errorMessage;
        ...
        protected DTResponse(int draw, int totalRecords, int totalRecordsFiltered, object data)
        ...
        /// <param name="data">Data object (collection).</param>
        protected DTResponse(int draw, int totalRecords, int totalRecordsFiltered, object data, IDictionary<string, object> additionalParameters)
        {
            Draw = draw;
        ...
        public static DTResponse Create(IDTRequest request, int totalRecords, int totalRecordsFiltered, object data)
        {
            return DTResponse.Create(request, totalRecords, totalRecordsFiltered, data, null);
        }
        /// <summary>
        /// Creates a new response instance.
        /// </summary>
        ...
        /// <param name="additionalParameters">Aditional parameters for response.</param>
        /// <returns>The response object.</returns>
        public static DTResponse Create(IDTRequest request, int totalRecords, int totalRecordsFiltered, object data, IDictionary<string, object> additionalParameters)
        {
            // When request is null, there should be no response (null response).
            if (request == null) return null;

            if (Xf.FM.DataTables.Configuration.Options.IsDrawValidationEnabled)
            {
            ...
            return new DTResponse(request.Draw, totalRecords, totalRecordsFiltered, data, additionalParameters);
        }
        /// <summary>
        /// Creates a new response instance.
        /// </summary>
        ...
        /// <param name="errorMessage">Error message.</param>
        /// <returns>The response object.</returns>
        public static DTResponse Create(IDTRequest request, string errorMessage)
        {
            return DTResponse.Create(request, errorMessage, null);
        }
        /// <summary>
        /// Creates a new response instance.
        /// </summary>
        ...
        /// <param name="errorMessage">Error message.</param>
        /// <returns>The response object.</returns>
        public static DTResponse Create(IDTRequest request, string errorMessage, IDictionary<string, object> additionalParameters)
        {
            // When request is null, there should be no response (null response).
            if (request == null) return null;
            ...
            return new DTResponse(request.Draw, errorMessage, additionalParameters);
        }
    }
}
