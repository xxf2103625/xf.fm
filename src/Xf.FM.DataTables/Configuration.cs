...
namespace Xf.FM.DataTables
{
    ...
    public static class Configuration
    {
        ...
        public static void RegisterDataTables(this IServiceCollection services, IOptions options) { services.RegisterDataTables(options, new DtModelBinder()); }
        ...
        public static void RegisterDataTables(this IServiceCollection services, DtModelBinder requestModelBinder) { services.RegisterDataTables(new Options(), requestModelBinder); }
        ...
        public static void RegisterDataTables(this IServiceCollection services, Func<ModelBindingContext, IDictionary<string, object>> parseRequestAdditionalParameters, bool parseResponseAdditionalParameters) { services.RegisterDataTables(new Options(), new DtModelBinder(), parseRequestAdditionalParameters, parseResponseAdditionalParameters); }
        ...
        public static void RegisterDataTables(this IServiceCollection services, IOptions options, DtModelBinder requestModelBinder) { services.RegisterDataTables(options, requestModelBinder, null, false); }
        ...
        public static void RegisterDataTables(this IServiceCollection services, IOptions options, DtModelBinder requestModelBinder, Func<ModelBindingContext, IDictionary<string, object>> parseRequestAdditionalParameters, bool enableResponseAdditionalParameters)
        {
        ...
        internal class ModelBinderProvider : IModelBinderProvider
        {
            ...
            public IModelBinder GetBinder(ModelBinderProviderContext context)
            {
                ...
                {
                    if (ModelBinder == null) ModelBinder = new DtModelBinder();
                    return ModelBinder;
                }
                else return null;
            }
            private bool IsBindable(Type type) { return type.Equals(typeof(Xf.FM.DataTables.IDTRequest)); }
        }
    }
}
